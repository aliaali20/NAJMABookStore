        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImgageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "products",
                columns: new[] { "Id", "Author", "CategoryId", "Description", "ISBN", "ImgageUrl", "ListPrice", "Price", "Price100", "Price50", "Title" },
                values: new object[,]
                {
